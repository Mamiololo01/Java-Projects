...
public class DonorUI {
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in); // displays the drop-down
        DonorCollection dc = new DonorCollection(); //object
//        DonorValidation dv = new DonorValidation(); //object
        while (true) {
            try {
                ...
                int ch = sc.nextInt(); // user input details
                switch (ch) {
                    case 1:
